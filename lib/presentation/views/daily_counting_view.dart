...
import 'package:counting_app/presentation/views/daily_counting_setting_view.dart';
...
class DailyCountingView extends StatefulWidget {
  ...
  @override
  State<DailyCountingView> createState() => _DailyCountingViewState();
}

class _DailyCountingViewState extends State<DailyCountingView> {
  ...
  void _navigateToSettings() async {
    ...
    final result = await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => DailyCountingSettingView(categories: _categories),
      ),
    );
